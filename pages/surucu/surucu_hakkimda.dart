...
class SurucuHakkimda extends StatefulWidget {
  const SurucuHakkimda({super.key});

  @override
  _SurucuHakkimdaState createState() => _SurucuHakkimdaState();
}

class _SurucuHakkimdaState extends State<SurucuHakkimda> {
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text(
                              ...
                              style: const TextStyle(
                                ...
                                color: AppStyles.textColorWhite, // Yazı rengi beyaz
                                fontWeight: FontWeight.bold,
                              ),
                            ),
                          ),
