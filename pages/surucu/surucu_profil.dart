...
class SurucuProfil extends StatefulWidget {
  const SurucuProfil({super.key});

  @override
  _SurucuProfilState createState() => _SurucuProfilState();
}

class _SurucuProfilState extends State<SurucuProfil> {
      ...
      if (result.isNotEmpty) {
        setState(() {
          userProfile = {
            ...
            'Taksi Plakası': result.first['taxi_plate'] ?? '',
    ...
    try {
      ...
      await conn.query(
        ...
        [
          ...
          _getNullableValue(controllers['Taksi Plakası']?.text),
          profileImageUrl,
          username,
        ],
      );
