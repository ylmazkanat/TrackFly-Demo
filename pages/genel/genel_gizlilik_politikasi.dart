...
class GenelGizlilikPolitikasi extends StatefulWidget {
  const GenelGizlilikPolitikasi({super.key});

  @override
  _GizlilikPolitikasiState createState() => _GizlilikPolitikasiState();
}

class _GizlilikPolitikasiState extends State<GenelGizlilikPolitikasi> {
